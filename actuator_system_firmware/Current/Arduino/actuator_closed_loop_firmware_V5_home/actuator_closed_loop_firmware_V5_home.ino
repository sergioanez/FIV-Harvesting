...
//  }
    ...
    x_ref =  0;
    y_ref =  (20*8/0.1)*sin(1*2*3.14159265*millis()/1000); // reads reference y position adn converts mm position input into step domain
    spd =  100; //900000/20*8*0.1*2*2*3.14159265*cos(2*2*3.14159265*millis()/1000);
    if (spd == 0){
      spd = 500;
    }
    if (spd > 500){
