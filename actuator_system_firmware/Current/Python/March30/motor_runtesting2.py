...
while True:
    ...
    t1 = clockTime;
    delta_t = t1-t2;
    dx = 300 #+ round(a*0.5*w*0.5*math.sin(w*0.5*t),0))# + round(a*3*w*0.1*math.sin(w*3*t),0)); #delta_y/delta_t;
    ...
    y = (10*8/0.1)*step #round(a*math.sin(w*t),0)    #12800 + round(a*math.sin(w*t),0)# + round(a*0.5*math.sin(w*0.5*t),0) + round(a*0.1*math.sin(w*3*t),0)
